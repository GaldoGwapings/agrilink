...
// Using standard Leaflet marker icons from CDN to avoid build issues with local assets
...
export default function MapView() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 lg:px-16 h-[calc(100vh-12rem)] flex flex-col gap-6">
              ...
              <Popup>
                <div className="p-4 min-w-[200px] space-y-3">
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-[#5B6D44] uppercase tracking-widest leading-none">{h.cropType}</p>
