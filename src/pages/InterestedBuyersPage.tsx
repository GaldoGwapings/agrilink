...
export default function InterestedBuyersPage({ user }: InterestedBuyersPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9F2]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-10 pb-20">
        {/* ── Header ── */}
        <header className="space-y-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              <h1 className="text-5xl font-black text-[#1A2E05] tracking-tight">
                Interested Buyers
              </h1>
              <p className="text-[#5B6D44] font-medium max-w-xl">
                Manage potential buyers interested in your upcoming harvests.
                Respond quickly to secure your sales.
              </p>
            </div>
          ...
          <AnimatePresence>
            {filteredBuyers.map((buyer) => (
              ...
              >
                ...
                {/* Done button — only shown for pending buyers */}
                {buyer.status === "pending" && (
                  <div className="pt-6">
                    <button
